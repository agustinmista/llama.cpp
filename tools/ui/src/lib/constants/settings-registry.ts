...
const SETTINGS_REGISTRY: Record<string, SettingsSectionEntry> = {
	...
	[SETTINGS_SECTION_SLUGS.DEVELOPER]: {
		...
		settings: [
			...
			{
				key: SETTINGS_KEYS.SVG_RENDER_ENABLED,
				label: 'SVG embedding tool',
				help: 'Expose a render_svg tool to the model. Accepts raw SVG markup (optionally generated by D3) and renders it in the chat after sanitization.',
				defaultValue: false,
				type: SettingsFieldType.CHECKBOX,
				section: SETTINGS_SECTION_SLUGS.DEVELOPER
			},
